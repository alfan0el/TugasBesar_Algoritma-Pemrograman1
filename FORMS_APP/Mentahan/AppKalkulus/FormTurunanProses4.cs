...
{
    public partial class FormTurunanProses4 : Form
    {
        public FormTurunanProses4()
        {
            InitializeComponent();
        }
        ...
        private void buttonHitung_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int jumlahn1, jumlahPangkat1, jumlahn2, jumlahPangkat2, jumlahn3, jumlahPangkat3, jumlahn4, jumlahPangkat4;
                ...
                this.textBoxNY1.Text = n1 + ".x^" + p1 + " + " + n2 + ".x^" + p2 + " + " + n3 + ".x^" + p3 + " + " + n4 + ".x^" + p4;
                this.textBoxNY2.Text = jumlahn1 + ".x^" + jumlahPangkat1 + " + " + jumlahn2 + ".x^" + jumlahPangkat2 + " + " + jumlahn3 + ".x^" + jumlahPangkat3 + " + " + jumlahn4 + ".x^" + jumlahPangkat4;
            }
        }
