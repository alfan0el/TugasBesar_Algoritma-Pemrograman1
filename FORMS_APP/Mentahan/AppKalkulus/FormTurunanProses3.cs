...
{
    public partial class FormTurunanProses3 : Form
    {
        public FormTurunanProses3()
        {
            InitializeComponent();
        }
        private void buttonHitung_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int jumlahn1, jumlahPangkat1, jumlahn2, jumlahPangkat2, jumlahn3, jumlahPangkat3;
                ...
                this.textBoxNY1.Text = n1 + ".x^" + p1 + " + " + n2 + ".x^" + p2 + " + " + n3 + ".x^" + p3;
                this.textBoxNY2.Text = jumlahn1 + ".x^" + jumlahPangkat1 + " + " + jumlahn2 + ".x^" + jumlahPangkat2 + " + " + jumlahn3 + ".x^" + jumlahPangkat3;
            }
        }
